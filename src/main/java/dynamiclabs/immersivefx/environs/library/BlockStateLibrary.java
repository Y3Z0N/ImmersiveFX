...
import dynamiclabs.immersivefx.environs.library.config.BlockConfig;
import dynamiclabs.immersivefx.environs.library.config.EffectConfig;
...
import dynamiclabs.immersivefx.environs.library.config.*;
